...
export const CriterionCard: React.FC<CriterionCardProps> = ({
  ...
  const [memberList, setMemberList] = useState<BlueprintMemberItem[]>([
    { id: 'kyluong', name: 'Lương Công Kỳ (163188)', role: 'Senior Developer / Manager' },
    { id: 'ducnguyen', name: 'Nguyễn Quang Đức (173232)', role: 'Developer / PIC' },
    { id: 'hieudao', name: 'Đào Trung Hiếu (183322)', role: 'Người đăng kí / Requester' },
    { id: 'anlt', name: 'Lê Trọng Ân (213813)', role: 'Developer' },
    { id: 'tungha', name: 'Hà Việt Tùng (213866)', role: 'Developer / PIC' },
    { id: 'hyle', name: 'Lê Minh Hy (213844)', role: 'Developer / PIC' },
    { id: 'diemtran', name: 'Trần Quang Diệm (227031)', role: 'Người đăng kí / Requester' },
    { id: 'ngocnb', name: 'Nguyễn Bá Ngọc (237157)', role: 'Developer / PIC' },
    { id: 'thienvo', name: 'Võ Chí Thiện (237196)', role: 'Người đăng kí / Requester' },
    { id: 'nhanph', name: 'Phan Huy Nhân (247203)', role: 'Developer / PIC' },
    { id: 'phuocnt', name: 'Nguyễn Thành Phước (247097)', role: 'Developer / PIC' },
    { id: 'nhatpham', name: 'Phạm Mai Nhật (203701)', role: 'Developer / PIC' },
    { id: 'xuanthai', name: 'Thái Thanh Xuân (203755)', role: 'Developer / PIC' },
    { id: 'lamnguyen', name: 'Nguyễn Sỹ Hoàng Lâm (247204)', role: 'Developer / PIC' },
    { id: 'thangpham', name: 'Phạm Hữu Thắng (247222)', role: 'Developer / PIC' },
    { id: 'phuongcq', name: 'Chung Quang Phương (247423)', role: 'Developer / PIC' },
    { id: 'khoadang', name: 'Đặng Phước Khoa (267036)', role: 'Developer / PIC' },
    { id: 'minhdoan', name: 'Đoàn Anh Minh (213835)', role: 'Developer / PIC' },
    { id: 'trungqn', name: 'Nguyễn Quang Trung (193613)', role: 'Developer / PIC' },
    { id: 'quangnguyen', name: 'Nguyễn Minh Quang (257130)', role: 'Developer / PIC' },
  ]);
