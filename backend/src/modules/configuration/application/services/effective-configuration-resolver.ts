...
export class EffectiveConfigurationResolver {
  ...
  public async resolve(
    ...
    const templateKpis = await this.templateKpiRepo.findByTemplateVersionId(templateVersionId);
    ...
    const resolvedCriteria: (ResolvedCriterion & { kpi_id?: string; template_kpi_id?: string })[] = [];
    const resolvedKpis = [];
